...
var CSsubmitButton = document.getElementById('cs-submit-1605'); // your local storage reset for local testing. uncomment this command so you can still access you pop up after clicking the close or submit button.
...
CScloseButton.addEventListener('click', handleClose); // if you remove the form, remove this below or you will get an error

CSsubmitButton.addEventListener('click', handleClose); // Function to check localStorage and apply class and style if needed, this prevents the pop up from popping up again if you already submitted your email or closed the pop up. Becuase persistant pop ups are annoying
...
window.addEventListener('load', checkLocalStorage); // Wait for .5 seconds to add the 'cs-loaded' class 
